  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm '>

      {
        ...
        {
          isEdit ? 
          <input className='bg-gray-50 text-3xl font-medium max-w-60 mt-4' type="text" min={1} value={userData.name} onChange={(e) => setUserData(prev => ({...prev,name:e.target.value}))} />
