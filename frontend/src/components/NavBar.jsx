...
const NavBar = () => {
  ...
  return (
    <div className='flex justify-between items-center py-4 mb-5 text-sm border-b-gray-400 border-b'>
        <img onClick={() => navigate('/')} className='w-28 sm:w-44 cursor-pointer' src={assets.logo} alt=''/>
