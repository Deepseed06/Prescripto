...
const Banner = () => {
  ...
  return (
    <div className='flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-24 md:mx-10 '>
        <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-20 lg:pl-5'>
            <div className='text-nowrap text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-white '>
